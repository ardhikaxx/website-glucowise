    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form id="editForm" action="{{ route('riwayatKesehatan.update', $data->id_riwayat) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="kategori_risiko" class="form-control" required>
                                    <option value="Rendah" {{ $data->kategori_risiko == 'Rendah' ? 'selected' : '' }}>Rendah
                                    </option>
                                    <option value="Sedang" {{ $data->kategori_risiko == 'Sedang' ? 'selected' : '' }}>Sedang
                                    </option>
                                    <option value="Tinggi" {{ $data->kategori_risiko == 'Tinggi' ? 'selected' : '' }}>Tinggi
                                    </option>
                                </select>
                            </div>
