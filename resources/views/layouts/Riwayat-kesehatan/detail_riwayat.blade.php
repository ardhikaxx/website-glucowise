...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-title text-center" style="color: #34B3A0; font-weight: 700;">Detail Rekam Medis - NIK:
                    {{ $latestDataPerMonth->first()->dataKesehatan->nik }}</h1>
            </div>
        </div>
                            ...
                            <div class="col-md-8">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr class="table-row">
                                            <th>Nama Lengkap</th>
                                            <td>{{ $latestDataPerMonth->first()->dataKesehatan->pengguna->nama_lengkap }}
                                            </td>
                                        </tr>
                                        <tr class="table-row">
                                            <th>Alamat Lengkap</th>
                                            <td>{{ $latestDataPerMonth->first()->dataKesehatan->pengguna->alamat_lengkap }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($latestDataPerMonth as $index => $data)
                                        <tr class="table-row">
                                            ...
                                            <td>
                                                <!-- Action Buttons -->
                                                <a href="{{ route('riwayatKesehatan.edit', $data->id_riwayat) }}"
